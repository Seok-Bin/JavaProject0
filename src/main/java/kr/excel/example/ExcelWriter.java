...
import kr.excel.entity.MerberVO;
...
public class ExcelWriter {
    public static void main(String[] args) {
        ...
        List<MerberVO> members = new ArrayList<>();
        ...
        while (true){
            ...
            MerberVO member = new MerberVO(name, age, birthday, phone, address,isMarried);
            members.add(member);
        }
        scanner.close();
        try {
            ...
            for (int i = 0; i < members.size(); i++) {
                ...
                row.createCell(5).setCellValue(member.isiSMarried());
            }
